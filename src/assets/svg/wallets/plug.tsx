...
export const PlugIcon = ({ className, onClick }: IconProps) => {
  return (
    <svg
      className={className}
      onClick={onClick}
    ...
    >
      ...
      />
      <path
        d="M504 60C504 26.8629 530.863 0 564 0H838C871.137 0 898 26.8629 898 60V966H504V60Z"
        fill="#031514"
      />
      <path
        d="M1792 60C1792 26.8629 1818.86 0 1852 0H2126C2159.14 0 2186 26.8629 2186 60V966H1792V60Z"
        fill="#031514"
      />
      ...
      />
      <circle cx="987.542" cy="1797.18" r="89.1743" fill="#031514" />
      <circle cx="1018.7" cy="1836.94" r="30.0829" fill="white" />
      <circle cx="1711.37" cy="1797.18" r="89.1743" fill="#031514" />
      <circle cx="1742.53" cy="1836.94" r="30.0829" fill="white" />
      <path
